...
for i in range(model_num):
    ...
    #model.load_state_dict(torch.load(f"ori_resnet18_cifar10_%f_%d.pth" % (lr, i)))  # Load the trained weights
    print("Load model ", i)
    model.load_state_dict(torch.load(f"./resnet18_cifar10_last_%f_%d.pth" % (lr, i)))  # Load the trained weights
